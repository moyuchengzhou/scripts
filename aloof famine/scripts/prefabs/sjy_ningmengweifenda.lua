...
local assets = {Asset("ANIM", "anim/sjy_ningmengweifenda.zip"),Asset("IMAGE", "images/inventoryimages/sjy_ningmengweifenda.tex"),Asset("ATLAS", "images/inventoryimages/sjy_ningmengweifenda.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_execute", "sjy_buff_execute")
...
function fn()
    local assetname = "sjy_ningmengweifenda"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_ningmengweifenda.xml" -- 在背包里的贴图
...
return Prefab("sjy_ningmengweifenda", fn, assets, prefabs)