local assets = {
    Asset("ANIM", "anim/myjmdqt_3_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/myjmdqt_3_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/myjmdqt_3_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/myjmdqt_3", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("myjmdqt_3_changpian")
    inst.AnimState:SetBuild("myjmdqt_3_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/myjmdqt_3_changpian.xml"
...
return Prefab("myjmdqt_3_changpian", fn, assets)
