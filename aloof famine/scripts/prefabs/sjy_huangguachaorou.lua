...
local assets = {Asset("ANIM", "anim/sjy_huangguachaorou.zip"), Asset("IMAGE", "images/sjy_huangguachaorou.tex"), Asset("ATLAS", "images/sjy_huangguachaorou.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("黄瓜炒肉！！！")		
            end
...
function fn()
    local assetname = "sjy_huangguachaorou"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_huangguachaorou.xml" -- 在背包里的贴图
...
return Prefab("sjy_huangguachaorou", fn, assets, prefabs)