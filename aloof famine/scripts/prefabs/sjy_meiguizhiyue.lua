...
local assets = {Asset("ANIM", "anim/sjy_meiguizhiyue.zip"), Asset("IMAGE", "images/sjy_meiguizhiyue.tex"), Asset("ATLAS", "images/sjy_meiguizhiyue.xml")}

local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") and eater.prefab =="waxwell"  then -- 判断是玩家
...
function fn()
    local assetname = "sjy_meiguizhiyue"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_meiguizhiyue.xml" -- 在背包里的贴图
...
return Prefab("sjy_meiguizhiyue", fn, assets, prefabs)