...
local assets = {Asset("ANIM", "anim/sjy_bingpimeiqiutuanzi.zip"), Asset("IMAGE", "images/sjy_bingpimeiqiutuanzi.tex"), Asset("ATLAS", "images/sjy_bingpimeiqiutuanzi.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("好可爱是仿制霉球怪！！！")		
            end
...
function fn()
    local assetname = "sjy_bingpimeiqiutuanzi"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_bingpimeiqiutuanzi.xml" -- 在背包里的贴图
...
return Prefab("sjy_bingpimeiqiutuanzi", fn, assets, prefabs)