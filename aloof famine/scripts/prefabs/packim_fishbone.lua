local assets =
{
    ...
    Asset("IMAGE", "images/inventoryimages/yugu.tex"),
    Asset("ATLAS", "images/inventoryimages/yugu.xml"),
    Asset("IMAGE", "images/inventoryimages/siyugu.tex"),
    Asset("ATLAS", "images/inventoryimages/siyugu.xml"),
}
...
local function OpenEye(inst)
    if not inst.isOpenEye then
        inst.isOpenEye = true
        inst.components.inventoryitem.atlasname = "images/inventoryimages/yugu.xml"	
...
local function CloseEye(inst)
    if inst.isOpenEye then
        inst.isOpenEye = nil
        inst.components.inventoryitem.atlasname = "images/inventoryimages/siyugu.xml"	
...
local function fn()
    ...
    inst.openEye = "yugu"
    inst.closedEye = "siyugu" 
    inst.isOpenEye = nil

    inst:AddComponent("inventoryitem")
	inst.components.inventoryitem.atlasname = "images/inventoryimages/yugu.xml"	
	inst.caminho = "images/inventoryimages/yugu.xml"	

    inst.components.inventoryitem:SetOnPutInInventoryFn(OnPutInInventory)
    inst.components.inventoryitem:ChangeImageName(inst.closedEye) --更改名字
