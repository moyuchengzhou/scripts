local assets =
{
    ...
    Asset("ANIM", "anim/banlike.zip"),
    -- Asset("ANIM", "anim/jiucai.zip"),
    -- Asset("SOUND", "sound/common.fsb"),
    Asset("IMAGE", "images/inventoryimages/banlike.tex"),
	Asset("ATLAS", "images/inventoryimages/banlike.xml"),
}
...
local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "banlike", "banlike")
...
local function on_inventory_hit(inst, attacker, target)
    ...
    SpawnPrefab("banlike").Transform:SetPosition(x, y, z)
...
local function fn()
    ...
    inst.AnimState:SetBank("banlike")
    inst.AnimState:SetBuild("banlike")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/banlike.xml"
...
return Prefab("banlike", fn, assets, prefabs)
