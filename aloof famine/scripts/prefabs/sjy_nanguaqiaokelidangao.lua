...
local assets = {Asset("ANIM", "anim/sjy_nanguaqiaokelidangao.zip"), Asset("IMAGE", "images/sjy_nanguaqiaokelidangao.tex"), Asset("ATLAS", "images/sjy_nanguaqiaokelidangao.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("是巧克力蛋糕~")		
            end
...
function fn()
    local assetname = "sjy_nanguaqiaokelidangao"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_nanguaqiaokelidangao.xml" -- 在背包里的贴图
...
return Prefab("sjy_nanguaqiaokelidangao", fn, assets, prefabs)