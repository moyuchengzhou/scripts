...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.sjx = "外皮如水晶般晶莹剔透"

local assets = {Asset("ANIM", "anim/sjx.zip"), Asset("IMAGE", "images/sjx.tex"), Asset("ATLAS", "images/sjx.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("外皮如水晶般晶莹剔透，送入口中，舌尖仿佛有鲜活的虾在蹦跳。直让人感叹一份四只的数量实在不够大快朵颐。!!!")		
            end
        end
end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/sjx.xml" -- 在背包里的贴图
...
return Prefab("sjx", fn, assets, prefabs)