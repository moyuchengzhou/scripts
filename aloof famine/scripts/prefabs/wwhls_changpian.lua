local assets = {
    Asset("ANIM", "anim/wwhls_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/wwhls_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/wwhls_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/wwhls", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("wwhls_changpian")
    inst.AnimState:SetBuild("wwhls_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/wwhls_changpian.xml"
...
return Prefab("wwhls_changpian", fn, assets)
