...
local assets = {Asset("ANIM", "anim/sjy_zhituodangao.zip"), Asset("IMAGE", "images/sjy_zhituodangao.tex"), Asset("ATLAS", "images/sjy_zhituodangao.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("可爱的小蛋糕~")		
            end
...
function fn()
    local assetname = "sjy_zhituodangao"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_zhituodangao.xml" -- 在背包里的贴图
...
return Prefab("sjy_zhituodangao", fn, assets, prefabs)