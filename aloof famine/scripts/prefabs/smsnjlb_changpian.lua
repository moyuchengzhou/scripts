local assets = {
    Asset("ANIM", "anim/smsnjlb_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/smsnjlb_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/smsnjlb_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/smsnjlb", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("smsnjlb_changpian")
    inst.AnimState:SetBuild("smsnjlb_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/smsnjlb_changpian.xml"
...
return Prefab("smsnjlb_changpian", fn, assets)
