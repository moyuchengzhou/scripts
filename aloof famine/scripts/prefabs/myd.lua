...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.MYD = "海鲜料理"

local assets = {Asset("ANIM", "anim/myd.zip"), Asset("IMAGE", "images/myd.tex"), Asset("ATLAS", "images/myd.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("趁热轻咬，弹嫩肉馅伴随着鲜美汁水正中味蕾的软肋，虾肉的回甘更似画龙点睛的一笔!!!")		
            end
        end
end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/myd.xml" -- 在背包里的贴图
...
return Prefab("myd", fn, assets, prefabs)