local assets =
{
    Asset("ANIM", "anim/changpianji.zip"),
    Asset("INV_IMAGE", "changpianji"),
    Asset("MINIMAP_IMAGE", "changpianji"),
    Asset("IMAGE", "images/inventoryimages/changpianji.tex"),
	Asset("ATLAS", "images/inventoryimages/changpianji.xml"),
}
...
local function play_song(inst, song)
    ...
    inst._stop_song_task = inst:DoTaskInTime(9999999, inst.TurnOffMachine)
...
local function fn()
    ...
    inst.AnimState:SetBank("changpianji")
    inst.AnimState:SetBuild("changpianji")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/changpianji.xml"
...
return Prefab("changpianji", fn, assets, prefabs)
