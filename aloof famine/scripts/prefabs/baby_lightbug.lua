-- local assets =
-- {
--     Asset("ANIM", "anim/baby_lightbug.zip"),
...
--     inst.AnimState:SetBank("baby_lightbug")
--     inst.AnimState:SetBuild("baby_lightbug")
...
-- return Prefab("baby_lightbug", fn, assets, prefabs)
