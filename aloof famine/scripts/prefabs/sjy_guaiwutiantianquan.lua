...
local assets = {Asset("ANIM", "anim/sjy_guaiwutiantianquan.zip"), Asset("IMAGE", "images/sjy_guaiwutiantianquan.tex"), Asset("ATLAS", "images/sjy_guaiwutiantianquan.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("布丁！！！")		
            end
...
function fn()
    local assetname = "sjy_guaiwutiantianquan"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_guaiwutiantianquan.xml" -- 在背包里的贴图
...
return Prefab("sjy_guaiwutiantianquan", fn, assets, prefabs)