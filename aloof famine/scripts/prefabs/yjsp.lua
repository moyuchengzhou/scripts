...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.YJSP = "派蒙才不是应急食品！还不如飞行矮堇瓜！！！"

local assets = {Asset("ANIM", "anim/yjsp.zip"), Asset("IMAGE", "images/yjsp.tex"), Asset("ATLAS", "images/yjsp.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("派蒙才不是应急食品！！！")		
            end
        end
end

function fn()
    local assetname = "yjsp"
    ...
    inst.components.inventoryitem.atlasname = "images/yjsp.xml" -- 在背包里的贴图
...
return Prefab("yjsp", fn, assets, prefabs)