...
local assets = {Asset("ANIM", "anim/sjy_dongguadunrou.zip"), Asset("IMAGE", "images/sjy_dongguadunrou.tex"), Asset("ATLAS", "images/sjy_dongguadunrou.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("美味的炖肉！！")		
            end
...
function fn()
    local assetname = "sjy_dongguadunrou"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_dongguadunrou.xml" -- 在背包里的贴图
...
return Prefab("sjy_dongguadunrou", fn, assets, prefabs)