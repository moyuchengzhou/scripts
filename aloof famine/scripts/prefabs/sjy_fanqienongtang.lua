...
local assets = {Asset("ANIM", "anim/sjy_fanqienongtang.zip"), Asset("IMAGE", "images/sjy_fanqienongtang.tex"), Asset("ATLAS", "images/sjy_fanqienongtang.xml")}
...
function fn()
    local assetname = "sjy_fanqienongtang"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_fanqienongtang.xml" -- 在背包里的贴图
...
return Prefab("sjy_fanqienongtang", fn, assets, prefabs)