...
-- 加载贴图，动画
local assets = {Asset("ANIM", "anim/dhyb.zip"), Asset("IMAGE", "images/dhyb.tex"), Asset("ATLAS", "images/dhyb.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/dhyb.xml" -- 在背包里的贴图
...
return Prefab("dhyb", fn, assets, prefabs)