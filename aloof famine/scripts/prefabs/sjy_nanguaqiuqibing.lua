...
local assets = {Asset("ANIM", "anim/sjy_nanguaqiuqibing.zip"), Asset("IMAGE", "images/sjy_nanguaqiuqibing.tex"), Asset("ATLAS", "images/sjy_nanguaqiuqibing.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("美味的曲奇~")		
            end
...
function fn()
    local assetname = "sjy_nanguaqiuqibing"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_nanguaqiuqibing.xml" -- 在背包里的贴图
    ...
    inst.components.edible.healthvalue = 33
...
return Prefab("sjy_nanguaqiuqibing", fn, assets, prefabs)