...
local assets = {Asset("ANIM", "anim/sjy_yibeizhengliushui.zip"), 
Asset("IMAGE", "images/sjy_yibeizhengliushui.tex"),
 Asset("ATLAS", "images/sjy_yibeizhengliushui.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("纯净水~")		
            end
...
function fn()
    local assetname = "sjy_yibeizhengliushui"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_yibeizhengliushui.xml" -- 在背包里的贴图
...
return Prefab("sjy_yibeizhengliushui", fn, assets, prefabs)