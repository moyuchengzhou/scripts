...
-- 加载贴图，动画
local assets = {Asset("ANIM", "anim/nainao.zip"), Asset("IMAGE", "images/nainao.tex"), Asset("ATLAS", "images/nainao.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("感觉我的力量得到提升！")		
            end
        end
end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/nainao.xml" -- 在背包里的贴图
...
return Prefab("nainao", fn, assets, prefabs)