...
local assets = {Asset("ANIM", "anim/sjy_banlibudin.zip"), Asset("IMAGE", "images/sjy_banlibudin.tex"), Asset("ATLAS", "images/sjy_banlibudin.xml")}
...
function fn()
    local assetname = "sjy_banlibudin"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_banlibudin.xml" -- 在背包里的贴图
...
return Prefab("sjy_banlibudin", fn, assets, prefabs)