...
local assets = {Asset("ANIM", "anim/sjy_hongdouzhou.zip"), Asset("IMAGE", "images/sjy_hongdouzhou.tex"), Asset("ATLAS", "images/sjy_hongdouzhou.xml")}
...
function fn()
    local assetname = "sjy_hongdouzhou"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_hongdouzhou.xml" -- 在背包里的贴图
...
return Prefab("sjy_hongdouzhou", fn, assets, prefabs)