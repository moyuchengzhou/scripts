...
local assets = {Asset("ANIM", "anim/sjy_pingguoweimeinianda.zip"),Asset("IMAGE", "images/inventoryimages/sjy_pingguoweimeinianda.tex"),Asset("ATLAS", "images/inventoryimages/sjy_pingguoweimeinianda.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_hengwen", "sjy_buff_hengwen")
            eater.components.talker:Say("肥宅快乐水！！！")		
            end
...
function fn()
    local assetname = "sjy_pingguoweimeinianda"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_pingguoweimeinianda.xml" -- 在背包里的贴图
...
return Prefab("sjy_pingguoweimeinianda", fn, assets, prefabs)