...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.WHXC = "午后甜点"

local assets = {Asset("ANIM", "anim/whxc.zip"), Asset("IMAGE", "images/whxc.tex"), Asset("ATLAS", "images/whxc.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("全是小猫咪好可爱，都不舍得吃了~")		
            end
        end
end

function fn()
    local assetname = "whxc"
    ...
    inst.components.inventoryitem.atlasname = "images/whxc.xml" -- 在背包里的贴图
...
return Prefab("whxc", fn, assets, prefabs)