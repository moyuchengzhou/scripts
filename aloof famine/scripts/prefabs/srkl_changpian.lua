local assets = {
    Asset("ANIM", "anim/srkl_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/srkl_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/srkl_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/srkl", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("srkl_changpian")
    inst.AnimState:SetBuild("srkl_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/srkl_changpian.xml"
...
return Prefab("srkl_changpian", fn, assets)
