...
local assets = {Asset("ANIM", "anim/sjy_chengzhiweifenda.zip"),Asset("IMAGE", "images/inventoryimages/sjy_chengzhiweifenda.tex"),Asset("ATLAS", "images/inventoryimages/sjy_chengzhiweifenda.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_freeze", "sjy_buff_freeze")
            eater.components.talker:Say("芬达！！！")		
            end
...
function fn()
    local assetname = "sjy_chengzhiweifenda"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_chengzhiweifenda.xml" -- 在背包里的贴图
    ...
    inst.components.edible.sanityvalue = 22.2
...
return Prefab("sjy_chengzhiweifenda", fn, assets, prefabs)