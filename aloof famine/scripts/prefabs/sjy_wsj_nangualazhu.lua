...
local assets = 
{
   Asset("ANIM", "anim/sjy_wsj_nangualazhu.zip"), 
   Asset("IMAGE", "images/inventoryimages/sjy_wsj_nangualazhu.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_wsj_nangualazhu.xml"),
   --默认:雪人
}
...
function fn()
   ...
   inst.Light:SetIntensity(0.25)                   --强度
   inst.Light:SetColour(248/255, 206/255, 44/255)  --黄色

   inst.entity:AddAnimState()                      --添加动画组件
   inst.AnimState:SetBank("sjy_wsj_nangualazhu")        --
   inst.AnimState:SetBuild("sjy_wsj_nangualazhu")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_wsj_nangualazhu")                   --独有标签
...
return Prefab("sjy_wsj_nangualazhu", fn, assets),
MakePlacer("sjy_wsj_nangualazhu_placer", "sjy_wsj_nangualazhu", "sjy_wsj_nangualazhu", "idle")