...
local assets = {Asset("ANIM", "anim/sjy_caomeiweimeinianda.zip"),Asset("IMAGE", "images/inventoryimages/sjy_caomeiweimeinianda.tex"),Asset("ATLAS", "images/inventoryimages/sjy_caomeiweimeinianda.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("美年达！！！")		
            end
...
function fn()
    local assetname = "sjy_caomeiweimeinianda"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_caomeiweimeinianda.xml" -- 在背包里的贴图
...
return Prefab("sjy_caomeiweimeinianda", fn, assets, prefabs)