...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.LWWWT = "烹饪料理"

local assets = {Asset("ANIM", "anim/lwwwt.zip"), Asset("IMAGE", "images/lwwwt.tex"), Asset("ATLAS", "images/lwwwt.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("将新鲜土豆泥转动塑形,醒面后放入完屉蒸熟,再将蘑菇与肉洗净切丁,下油锅爆炒!!!")		
            end
        end
end

function fn()
    local assetname = "lwwwt"
    ...
    inst.components.inventoryitem.atlasname = "images/lwwwt.xml" -- 在背包里的贴图
...
return Prefab("lwwwt", fn, assets, prefabs)