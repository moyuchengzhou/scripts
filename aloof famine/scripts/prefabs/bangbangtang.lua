...
-- 加载贴图，动画
local assets = {Asset("ANIM", "anim/bangbangtang.zip"), Asset("IMAGE", "images/bangbangtang.tex"), Asset("ATLAS", "images/bangbangtang.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("干干净净，吃了没病！")		
            end
        end
end

function fn()
    local assetname = "bangbangtang"
    ...
    inst.components.inventoryitem.atlasname = "images/bangbangtang.xml" -- 在背包里的贴图
    ...
    inst.components.edible.hungervalue = 33.3
...
return Prefab("bangbangtang", fn, assets, prefabs)