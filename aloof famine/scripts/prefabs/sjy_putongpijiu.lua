...
local assets = {Asset("ANIM", "anim/sjy_putongpijiu.zip"),Asset("IMAGE", "images/inventoryimages/sjy_putongpijiu.tex"),Asset("ATLAS", "images/inventoryimages/sjy_putongpijiu.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_random_move_speed", "sjy_buff_random_move_speed")
...
function fn()
    local assetname = "sjy_putongpijiu"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_putongpijiu.xml" -- 在背包里的贴图
...
return Prefab("sjy_putongpijiu", fn, assets, prefabs)