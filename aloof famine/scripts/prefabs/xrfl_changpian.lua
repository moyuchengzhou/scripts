local assets = {
    Asset("ANIM", "anim/xrfl_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/xrfl_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/xrfl_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/xrfl", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("xrfl_changpian")
    inst.AnimState:SetBuild("xrfl_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/xrfl_changpian.xml"
...
return Prefab("xrfl_changpian", fn, assets)
