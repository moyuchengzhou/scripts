...
-- 加载贴图，动画
local assets = {Asset("ANIM", "anim/rg.zip"), Asset("IMAGE", "images/rg.tex"), Asset("ATLAS", "images/rg.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/rg.xml" -- 在背包里的贴图
...
return Prefab("rg", fn, assets, prefabs)