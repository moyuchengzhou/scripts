...
local assets = 
{
   Asset("ANIM", "anim/sjy_wsj_meiqiutuanzi.zip"),
   Asset("IMAGE", "images/inventoryimages/sjy_wsj_meiqiutuanzi.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_wsj_meiqiutuanzi.xml"),--默认:雪人
}
...
function fn()
   ...
   inst.Light:SetRadius(1*1)                       --发光范围:半径2格地皮
   inst.Light:SetFalloff(1)                        --衰减
   inst.Light:SetIntensity(0.09)                   --强度
   inst.Light:SetColour(216/255, 244/255, 232/255)  --黄色

   inst.entity:AddAnimState()                      --添加动画组件
   inst.AnimState:SetBank("sjy_wsj_meiqiutuanzi")        --
   inst.AnimState:SetBuild("sjy_wsj_meiqiutuanzi")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_wsj_meiqiutuanzi")                   --独有标签
...
return Prefab("sjy_wsj_meiqiutuanzi", fn, assets),
MakePlacer("sjy_wsj_meiqiutuanzi_placer", "sjy_wsj_meiqiutuanzi", "sjy_wsj_meiqiutuanzi", "idle")