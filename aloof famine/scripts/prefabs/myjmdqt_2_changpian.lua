local assets = {
    Asset("ANIM", "anim/myjmdqt_2_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/myjmdqt_2_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/myjmdqt_2_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/myjmdqt_2", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("myjmdqt_2_changpian")
    inst.AnimState:SetBuild("myjmdqt_2_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/myjmdqt_2_changpian.xml"
...
return Prefab("myjmdqt_2_changpian", fn, assets)
