...
local assets = {Asset("ANIM", "anim/sjy_shuizhuroupian.zip"), Asset("IMAGE", "images/sjy_shuizhuroupian.tex"), Asset("ATLAS", "images/sjy_shuizhuroupian.xml")}
...
function fn()
    local assetname = "sjy_shuizhuroupian"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_shuizhuroupian.xml" -- 在背包里的贴图
...
return Prefab("sjy_shuizhuroupian", fn, assets, prefabs)