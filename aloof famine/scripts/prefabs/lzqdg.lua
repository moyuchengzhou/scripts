...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.LZQDG = "蒸制而成的蛋料理!!!"

local assets = {Asset("ANIM", "anim/lzqdg.zip"), Asset("IMAGE", "images/lzqdg.tex"), Asset("ATLAS", "images/lzqdg.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("弹嫩的禽蛋羹融化于口中，一不留神便滑入喉头")		
            end
        end
end

function fn()
    local assetname = "lzqdg"
    ...
    inst.components.inventoryitem.atlasname = "images/lzqdg.xml" -- 在背包里的贴图
...
return Prefab("lzqdg", fn, assets, prefabs)