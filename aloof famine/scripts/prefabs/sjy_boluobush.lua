local assets =
{
    ...
    Asset("ANIM", "anim/sjy_boluobush.zip"),
    Asset("SOUND", "sound/common.fsb"),
    Asset("IMAGE", "images/inventoryimages/sjy_boluobush.tex"),
	Asset("ATLAS", "images/inventoryimages/sjy_boluobush.xml"),
}
...
local function dig_up(inst, worker)
    if inst.components.pickable ~= nil and inst.components.lootdropper ~= nil then
        ...
        if inst.components.pickable:CanBePicked() then
            ...
            inst.components.lootdropper:SpawnLootPrefab(withered and "sjy_boluobean" or "dug_sjy_boluobush")
        end
...
local function fn()
    local sjy_boluobush = "sjy_boluobush"
    ...
    inst.MiniMapEntity:SetIcon(sjy_boluobush..".tex")
    ...
    inst.AnimState:SetBank("sjy_boluobush")
    inst.AnimState:SetBuild("sjy_boluobush")
    ...
    inst.components.pickable:SetUp("sjy_boluobean", 2400)
...
return Prefab("sjy_boluobush", fn, assets, prefabs)
