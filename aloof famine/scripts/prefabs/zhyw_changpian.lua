local assets = {
    Asset("ANIM", "anim/zhyw_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/zhyw_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/zhyw_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/zhyw", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("zhyw_changpian")
    inst.AnimState:SetBuild("zhyw_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/zhyw_changpian.xml"
...
return Prefab("zhyw_changpian", fn, assets)
