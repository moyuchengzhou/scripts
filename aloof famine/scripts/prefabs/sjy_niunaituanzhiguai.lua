...
local assets = {Asset("ANIM", "anim/sjy_niunaituanzhiguai.zip"), Asset("IMAGE", "images/sjy_niunaituanzhiguai.tex"), Asset("ATLAS", "images/sjy_niunaituanzhiguai.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("香糯的牛奶团子~")		
            end
...
function fn()
    local assetname = "sjy_niunaituanzhiguai"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_niunaituanzhiguai.xml" -- 在背包里的贴图
...
return Prefab("sjy_niunaituanzhiguai", fn, assets, prefabs)