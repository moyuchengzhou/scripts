...
local assets = {Asset("ANIM", "anim/sjy_cocokele.zip"),Asset("IMAGE", "images/inventoryimages/sjy_cocokele.tex"),Asset("ATLAS", "images/inventoryimages/sjy_cocokele.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_cocokele.xml" -- 在背包里的贴图
...
return Prefab("sjy_cocokele", fn, assets, prefabs)