...
-- local assets =
-- {
--     Asset("ANIM", "anim/sjy_chaoguo.zip"),
...
--     inst.AnimState:SetBank("sjy_chaoguo")
--     inst.AnimState:SetBuild("sjy_chaoguo")
--     inst.AnimState:PlayAnimation("idle_empty")
--     inst.scrapbook_anim = "idle_empty"
--     inst.MiniMapEntity:SetIcon("sjy_chaoguo.tex")
-- end
...
--         inst.components.container:WidgetSetup("sjy_chaoguo")
...
-- return MakeCookPot("sjy_chaoguo", cookpot_common, cookpot_common_master, assets, prefabs),
--     MakePlacer("sjy_chaoguo_placer", "sjy_chaoguo", "sjy_chaoguo", "idle_empty")
