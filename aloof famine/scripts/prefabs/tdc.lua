...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.TDC = "烤制而成的小吃"

local assets = {Asset("ANIM", "anim/tdc.zip"), Asset("IMAGE", "images/tdc.tex"), Asset("ATLAS", "images/tdc.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("奶酪浓缩着迷人香气，宛如一条流金之河!!!")		
            end
        end
end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/tdc.xml" -- 在背包里的贴图
...
return Prefab("tdc", fn, assets, prefabs)