...
local assets = {Asset("ANIM", "anim/sjy_yingguanguoxianrengzhangshala.zip"), Asset("IMAGE", "images/sjy_yingguanguoxianrengzhangshala.tex"), Asset("ATLAS", "images/sjy_yingguanguoxianrengzhangshala.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("难以下咽~")		
            end
...
function fn()
    local assetname = "sjy_yingguanguoxianrengzhangshala"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_yingguanguoxianrengzhangshala.xml" -- 在背包里的贴图
...
return Prefab("sjy_yingguanguoxianrengzhangshala", fn, assets, prefabs)