...
local assets = 
{
   Asset("ANIM", "anim/sjy_jiangbingxiang2.zip"), 
   Asset("IMAGE", "images/inventoryimages/sjy_jiangbingxiang2.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_jiangbingxiang2.xml"),
   --默认:雪人
}
...
function fn()
   ...
   inst.AnimState:SetBank("sjy_jiangbingxiang2")        --
   inst.AnimState:SetBuild("sjy_jiangbingxiang2")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_jiangbingxiang2")                   --独有标签
   ...
   inst.components.container:WidgetSetup("sjy_jiangbingxiang2")
...
return Prefab("sjy_jiangbingxiang2", fn, assets),
MakePlacer("sjy_jiangbingxiang2_placer", "sjy_jiangbingxiang2", "sjy_jiangbingxiang2", "idle")