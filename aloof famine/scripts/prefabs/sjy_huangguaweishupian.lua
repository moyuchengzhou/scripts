...
local assets = {Asset("ANIM", "anim/sjy_huangguaweishupian.zip"),Asset("IMAGE", "images/inventoryimages/sjy_huangguaweishupian.tex"),Asset("ATLAS", "images/inventoryimages/sjy_huangguaweishupian.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("黄瓜味薯片！！！")		
            end
...
function fn()
    local assetname = "sjy_huangguaweishupian"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_huangguaweishupian.xml" -- 在背包里的贴图
...
return Prefab("sjy_huangguaweishupian", fn, assets, prefabs)