...
local assets = {Asset("ANIM", "anim/sjy_yanjinpijiu.zip"),Asset("IMAGE", "images/inventoryimages/sjy_yanjinpijiu.tex"),Asset("ATLAS", "images/inventoryimages/sjy_yanjinpijiu.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_heating", "sjy_buff_heating")
...
function fn()
    local assetname = "sjy_yanjinpijiu"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_yanjinpijiu.xml" -- 在背包里的贴图
...
return Prefab("sjy_yanjinpijiu", fn, assets, prefabs)