...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.sjy_yudoufu = "热乎乎鱼豆腐!!!"

local assets = {Asset("ANIM", "anim/sjy_yudoufu.zip"), Asset("IMAGE", "images/sjy_yudoufu.tex"), Asset("ATLAS", "images/sjy_yudoufu.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("鲜嫩爽滑!!!!")		
            end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_yudoufu.xml" -- 在背包里的贴图
...
return Prefab("sjy_yudoufu", fn, assets, prefabs)