...
local assets = 
{
   Asset("ANIM", "anim/sjy_wsj_youling.zip"), 
   Asset("IMAGE", "images/inventoryimages/sjy_wsj_youling.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_wsj_youling.xml"),
   --默认:雪人
}
...
function fn()
   ...
   inst.AnimState:SetBank("sjy_wsj_youling")        --
   inst.AnimState:SetBuild("sjy_wsj_youling")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_wsj_youling")                   --独有标签
...
return Prefab("sjy_wsj_youling", fn, assets),
MakePlacer("sjy_wsj_youling_placer", "sjy_wsj_youling", "sjy_wsj_youling", "idle")