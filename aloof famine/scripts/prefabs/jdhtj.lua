...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.jdhtj = "热乎乎的炖菜!!!"

local assets = {Asset("ANIM", "anim/jdhtj.zip"), Asset("IMAGE", "images/jdhtj.tex"), Asset("ATLAS", "images/jdhtj.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/jdhtj.xml" -- 在背包里的贴图
...
return Prefab("jdhtj", fn, assets, prefabs)