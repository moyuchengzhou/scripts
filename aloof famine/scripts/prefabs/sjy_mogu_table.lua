...
local assets =
{
    ...
    Asset("IMAGE", "images/inventoryimages/sjy_mogu_table.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_mogu_table.xml"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("sjy_mogu_table.tex")
    ...
    inst.components.container:WidgetSetup("sjy_mogu_table")
...
return Prefab("sjy_mogu_table", fn, assets, prefabs),
    MakePlacer("sjy_mogu_table_placer", "sjy_mogu_table", "sjy_mogu_table", "idle11")
