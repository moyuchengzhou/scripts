...
local assets = 
{
   Asset("ANIM", "anim/sjy_huangsenanguadeng.zip"),   
   Asset("IMAGE", "images/inventoryimages/sjy_huangsenanguadeng.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_huangsenanguadeng.xml"),--默认:雪人
}
...
function fn()
   ...
   inst.Light:SetColour(255/255, 180/255, 0/255)  --黄色

   inst.entity:AddAnimState()                      --添加动画组件
   inst.AnimState:SetBank("sjy_huangsenanguadeng")        --
   inst.AnimState:SetBuild("sjy_huangsenanguadeng")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_huangsenanguadeng")                   --独有标签
...
return Prefab("sjy_huangsenanguadeng", fn, assets),
MakePlacer("sjy_huangsenanguadeng_placer", "sjy_huangsenanguadeng", "sjy_huangsenanguadeng", "idle")