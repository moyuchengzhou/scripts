...
local assets = {Asset("ANIM", "anim/sjy_kekoukele.zip"),Asset("IMAGE", "images/inventoryimages/sjy_kekoukele.tex"),Asset("ATLAS", "images/inventoryimages/sjy_kekoukele.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_kekoukele.xml" -- 在背包里的贴图
...
return Prefab("sjy_kekoukele", fn, assets, prefabs)