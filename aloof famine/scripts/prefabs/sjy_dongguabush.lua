local assets =
{
    ...
    Asset("ANIM", "anim/sjy_dongguabush.zip"),
    Asset("SOUND", "sound/common.fsb"),
    Asset("IMAGE", "images/inventoryimages/sjy_dongguabush.tex"),
	Asset("ATLAS", "images/inventoryimages/sjy_dongguabush.xml"),
}
...
local function dig_up(inst, worker)
    if inst.components.pickable ~= nil and inst.components.lootdropper ~= nil then
        ...
        if inst.components.pickable:CanBePicked() then
            ...
            inst.components.lootdropper:SpawnLootPrefab(withered and "forgetmelots" or "dug_sjy_dongguabush")
        end
...
local function fn()
    local sjy_dongguabush = "sjy_dongguabush"
    ...
    inst.MiniMapEntity:SetIcon(sjy_dongguabush..".tex")
    ...
    inst.AnimState:SetBank("sjy_dongguabush")
    inst.AnimState:SetBuild("sjy_dongguabush")
    ...
    inst.components.pickable:SetUp("sjy_dongguabean", 2400)
...
return Prefab("sjy_dongguabush", fn, assets, prefabs)
