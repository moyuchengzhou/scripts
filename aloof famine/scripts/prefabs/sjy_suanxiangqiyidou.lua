...
local assets = {Asset("ANIM", "anim/sjy_suanxiangqiyidou.zip"), Asset("IMAGE", "images/sjy_suanxiangqiyidou.tex"), Asset("ATLAS", "images/sjy_suanxiangqiyidou.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("好极了~")		
            end
...
function fn()
    local assetname = "sjy_suanxiangqiyidou"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_suanxiangqiyidou.xml" -- 在背包里的贴图
...
return Prefab("sjy_suanxiangqiyidou", fn, assets, prefabs)