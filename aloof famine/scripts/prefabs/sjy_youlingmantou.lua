...
local assets = {Asset("ANIM", "anim/sjy_youlingmantou.zip"), Asset("IMAGE", "images/sjy_youlingmantou.tex"), Asset("ATLAS", "images/sjy_youlingmantou.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("好看的馒头~")		
            end
...
function fn()
    local assetname = "sjy_youlingmantou"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_youlingmantou.xml" -- 在背包里的贴图
...
return Prefab("sjy_youlingmantou", fn, assets, prefabs)