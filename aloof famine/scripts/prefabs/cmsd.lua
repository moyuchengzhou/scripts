...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.CMSD = "热乎乎的炖菜!!!"

local assets = {Asset("ANIM", "anim/cmsd.zip"), Asset("IMAGE", "images/cmsd.tex"), Asset("ATLAS", "images/cmsd.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("草莓味的冰激凌!!!!")		
            end
        end
end

function fn()
    local assetname = "cmsd"
    ...
    inst.components.inventoryitem.atlasname = "images/cmsd.xml" -- 在背包里的贴图
...
return Prefab("cmsd", fn, assets, prefabs)