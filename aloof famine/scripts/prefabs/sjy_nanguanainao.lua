...
local assets = {Asset("ANIM", "anim/sjy_nanguanainao.zip"), Asset("IMAGE", "images/sjy_nanguanainao.tex"), Asset("ATLAS", "images/sjy_nanguanainao.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("南瓜艺术！")		
            end
...
function fn()
    local assetname = "sjy_nanguanainao"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_nanguanainao.xml" -- 在背包里的贴图
...
return Prefab("sjy_nanguanainao", fn, assets, prefabs)