local assets =
{
    ...
    Asset("ANIM", "anim/sjy_dadoubush.zip"),
    Asset("SOUND", "sound/common.fsb"),
    Asset("IMAGE", "images/inventoryimages/sjy_dadoubush.tex"),
	Asset("ATLAS", "images/inventoryimages/sjy_dadoubush.xml"),
}
...
local function dig_up(inst, worker)
    if inst.components.pickable ~= nil and inst.components.lootdropper ~= nil then
        ...
        if inst.components.pickable:CanBePicked() then
            ...
            inst.components.lootdropper:SpawnLootPrefab(withered and "sjy_dadoubean" or "dug_sjy_dadoubush")
        end
...
local function fn()
    local sjy_dadoubush = "sjy_dadoubush"
    ...
    inst.MiniMapEntity:SetIcon(sjy_dadoubush..".tex")
    ...
    inst.AnimState:SetBank("sjy_dadoubush")
    inst.AnimState:SetBuild("sjy_dadoubush")
    ...
    inst.components.pickable:SetUp("sjy_dadoubean", 960,3)
...
return Prefab("sjy_dadoubush", fn, assets, prefabs)
