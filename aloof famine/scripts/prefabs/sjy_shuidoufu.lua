...
local assets = {Asset("ANIM", "anim/sjy_shuidoufu.zip"),Asset("IMAGE", "images/inventoryimages/sjy_shuidoufu.tex"),Asset("ATLAS", "images/inventoryimages/sjy_shuidoufu.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("新鲜的豆腐")		
            end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_shuidoufu.xml" -- 在背包里的贴图
...
return Prefab("sjy_shuidoufu", fn, assets, prefabs)