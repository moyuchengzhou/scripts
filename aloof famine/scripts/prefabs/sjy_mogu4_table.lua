...
local assets =
{
    ...
    Asset("IMAGE", "images/inventoryimages/sjy_mogu4_table.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_mogu4_table.xml"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("sjy_mogu4_table.tex")
    ...
    inst.components.container:WidgetSetup("sjy_mogu4_table")
...
return Prefab("sjy_mogu4_table", fn, assets, prefabs),
    MakePlacer("sjy_mogu4_table_placer", "sjy_mogu_table", "sjy_mogu_table", "idle44")
