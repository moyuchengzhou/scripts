...
local assets = {Asset("ANIM", "anim/sjy_miantuan.zip"), Asset("IMAGE", "images/sjy_miantuan.tex"), Asset("ATLAS", "images/sjy_miantuan.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("咦~谁会想不开啃面团")		
            end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_miantuan.xml" -- 在背包里的贴图
...
return Prefab("sjy_miantuan", fn, assets, prefabs)