local assets = {
    Asset("ANIM", "anim/crsjbb_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/crsjbb_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/crsjbb_changpian.xml"),
    Asset("SOUNDPACKAGE","sound/xincp.fev"),
    Asset("SOUND","sound/xincp.fsb"),
}

local RECORDS = {
    default = {song = "xincp/BGM/crsjbb", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("crsjbb_changpian")
    inst.AnimState:SetBuild("crsjbb_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/crsjbb_changpian.xml"
...
return Prefab("crsjbb_changpian", fn, assets)
