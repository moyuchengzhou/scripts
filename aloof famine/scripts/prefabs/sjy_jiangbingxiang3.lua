...
local assets = 
{
   Asset("ANIM", "anim/sjy_jiangbingxiang3.zip"), 
   Asset("IMAGE", "images/inventoryimages/sjy_jiangbingxiang3.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_jiangbingxiang3.xml"),
   --默认:雪人
}
...
function fn()
   ...
   inst.AnimState:SetBank("sjy_jiangbingxiang3")        --
   inst.AnimState:SetBuild("sjy_jiangbingxiang3")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_jiangbingxiang3")                   --独有标签
   ...
   inst.components.container:WidgetSetup("sjy_jiangbingxiang3")
...
return Prefab("sjy_jiangbingxiang3", fn, assets),
MakePlacer("sjy_jiangbingxiang3_placer", "sjy_jiangbingxiang3", "sjy_jiangbingxiang3", "idle")