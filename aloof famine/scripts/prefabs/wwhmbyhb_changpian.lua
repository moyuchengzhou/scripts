local assets = {
    Asset("ANIM", "anim/wwhmbyhb_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/wwhmbyhb_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/wwhmbyhb_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/wwhmbyhb", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("wwhmbyhb_changpian")
    inst.AnimState:SetBuild("wwhmbyhb_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/wwhmbyhb_changpian.xml"
...
return Prefab("wwhmbyhb_changpian", fn, assets)
