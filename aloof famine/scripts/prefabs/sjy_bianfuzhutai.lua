...
local assets = 
{
   Asset("ANIM", "anim/sjy_bianfuzhutai.zip"),
   Asset("IMAGE", "images/inventoryimages/sjy_bianfuzhutai.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_bianfuzhutai.xml"),--默认:雪人
}
...
function fn()
   ...
   inst.Light:SetColour(255/255, 146/255, 117/255)  --黄色

   inst.entity:AddAnimState()                      --添加动画组件
   inst.AnimState:SetBank("sjy_bianfuzhutai")        --
   inst.AnimState:SetBuild("sjy_bianfuzhutai")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle2")            --动画子名称,播放的就是它

   inst:AddTag("sjy_bianfuzhutai")                   --独有标签
...
return Prefab("sjy_bianfuzhutai", fn, assets),
MakePlacer("sjy_bianfuzhutai_placer", "sjy_bianfuzhutai", "sjy_bianfuzhutai", "idle2")