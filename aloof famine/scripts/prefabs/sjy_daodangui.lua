...
local assets = 
{
   Asset("ANIM", "anim/sjy_daodangui.zip"),  
   Asset("IMAGE", "images/inventoryimages/sjy_daodangui.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_daodangui.xml"),--默认:雪人
}
...
function fn()
   ...
   inst.Light:SetColour(49/255, 123/255, 22/255)  --黄色

   inst.entity:AddAnimState()                      --添加动画组件
   inst.AnimState:SetBank("sjy_daodangui")        --
   inst.AnimState:SetBuild("sjy_daodangui")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_daodangui")                   --独有标签
...
return Prefab("sjy_daodangui", fn, assets),
MakePlacer("sjy_daodangui_placer", "sjy_daodangui", "sjy_daodangui", "idle")