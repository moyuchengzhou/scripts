...
local assets = {Asset("ANIM", "anim/sjy_yuanweishupian.zip"),Asset("IMAGE", "images/inventoryimages/sjy_yuanweishupian.tex"),Asset("ATLAS", "images/inventoryimages/sjy_yuanweishupian.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_gold_explosion", "sjy_buff_gold_explosion")
            eater.components.talker:Say("原味薯片！！！")		
            end
...
function fn()
    local assetname = "sjy_yuanweishupian"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_yuanweishupian.xml" -- 在背包里的贴图
...
return Prefab("sjy_yuanweishupian", fn, assets, prefabs)