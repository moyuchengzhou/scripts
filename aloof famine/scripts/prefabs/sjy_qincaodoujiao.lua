...
local assets = {Asset("ANIM", "anim/sjy_qincaodoujiao.zip"), Asset("IMAGE", "images/sjy_qincaodoujiao.tex"), Asset("ATLAS", "images/sjy_qincaodoujiao.xml")}
...
function fn()
    local assetname = "sjy_qincaodoujiao"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_qincaodoujiao.xml" -- 在背包里的贴图
...
return Prefab("sjy_qincaodoujiao", fn, assets, prefabs)