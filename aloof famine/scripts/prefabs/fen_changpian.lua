local assets = {
    Asset("ANIM", "anim/fen_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/fen_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/fen_changpian.xml"),
    Asset("SOUNDPACKAGE","sound/xincp.fev"),
    Asset("SOUND","sound/xincp.fsb"),
}

local RECORDS = {
    default = {song = "xincp/BGM/fen", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("fen_changpian")
    inst.AnimState:SetBuild("fen_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/fen_changpian.xml"
...
return Prefab("fen_changpian", fn, assets)
