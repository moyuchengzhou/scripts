local assets = {
    Asset("ANIM", "anim/wwhmgqb_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/wwhmgqb_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/wwhmgqb_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/wwhmgqb", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("wwhmgqb_changpian")
    inst.AnimState:SetBuild("wwhmgqb_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/wwhmgqb_changpian.xml"
...
return Prefab("wwhmgqb_changpian", fn, assets)
