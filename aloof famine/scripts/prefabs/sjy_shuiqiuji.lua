...
local assets =
{
    ...
    Asset("IMAGE", "images/inventoryimages/sjy_shuiqiuji.tex"),
    Asset("ATLAS", "images/inventoryimages/sjy_shuiqiuji.xml")
}
...
local function LaunchProjectile(inst, targetpos)
    ...
    local projectile = SpawnPrefab("waterballoon")
...
local function fn()
    ...
    inst.components.machine.cooldowntime = 0.2
    ...
    inst.components.fueled:InitializeFuelLevel(2400000)
    inst.components.fueled.bonusmult = 10
...
return Prefab("sjy_shuiqiuji", fn, assets, prefabs),
    Prefab("sjy_shuiqiuji_glow", glow_fn, glow_assets),
    MakePlacer("sjy_shuiqiuji_placer", "firefighter_placement", "firefighter_placement", "idle", true, nil, nil, PLACER_SCALE, nil, nil, placer_postinit_fn)
