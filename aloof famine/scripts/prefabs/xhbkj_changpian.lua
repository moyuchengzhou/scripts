local assets = {
    Asset("ANIM", "anim/xhbkj_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/xhbkj_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/xhbkj_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/xhbkj", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("xhbkj_changpian")
    inst.AnimState:SetBuild("xhbkj_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/xhbkj_changpian.xml"
...
return Prefab("xhbkj_changpian", fn, assets)
