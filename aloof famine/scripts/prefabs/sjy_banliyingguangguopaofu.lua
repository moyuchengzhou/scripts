...
local assets = {Asset("ANIM", "anim/sjy_banliyingguangguopaofu.zip"), Asset("IMAGE", "images/sjy_banliyingguangguopaofu.tex"), Asset("ATLAS", "images/sjy_banliyingguangguopaofu.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("真美味虽然外观恶心。。。")		
            end
...
function fn()
    local assetname = "sjy_banliyingguangguopaofu"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_banliyingguangguopaofu.xml" -- 在背包里的贴图
...
return Prefab("sjy_banliyingguangguopaofu", fn, assets, prefabs)