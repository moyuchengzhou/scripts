...
local assets = {Asset("ANIM", "anim/sjy_hongjiu.zip"),Asset("IMAGE", "images/inventoryimages/sjy_hongjiu.tex"),Asset("ATLAS", "images/inventoryimages/sjy_hongjiu.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_cooling", "sjy_buff_cooling")
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_hongjiu.xml" -- 在背包里的贴图
...
return Prefab("sjy_hongjiu", fn, assets, prefabs)