...
-- 加载贴图，动画
local assets = {Asset("ANIM", "anim/stt.zip"), Asset("IMAGE", "images/stt.tex"), Asset("ATLAS", "images/stt.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/stt.xml" -- 在背包里的贴图
...
return Prefab("stt", fn, assets, prefabs)