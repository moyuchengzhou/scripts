...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.xzbd = "热乎乎的炖菜!!!"

local assets = {Asset("ANIM", "anim/xzbd.zip"), Asset("IMAGE", "images/xzbd.tex"), Asset("ATLAS", "images/xzbd.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/xzbd.xml" -- 在背包里的贴图
...
return Prefab("xzbd", fn, assets, prefabs)