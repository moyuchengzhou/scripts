...
local assets = {Asset("ANIM", "anim/sjy_chengzhiweimeinianda.zip"),Asset("IMAGE", "images/inventoryimages/sjy_chengzhiweimeinianda.tex"),Asset("ATLAS", "images/inventoryimages/sjy_chengzhiweimeinianda.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            -- eater.components.debuffable:AddDebuff("sx", "sx")
...
function fn()
    local assetname = "sjy_chengzhiweimeinianda"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_chengzhiweimeinianda.xml" -- 在背包里的贴图
...
return Prefab("sjy_chengzhiweimeinianda", fn, assets, prefabs)