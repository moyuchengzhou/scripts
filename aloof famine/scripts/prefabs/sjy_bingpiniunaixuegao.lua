...
local assets = {Asset("ANIM", "anim/sjy_bingpiniunaixuegao.zip"), Asset("IMAGE", "images/sjy_bingpiniunaixuegao.tex"), Asset("ATLAS", "images/sjy_bingpiniunaixuegao.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("冰皮雪糕！！！")		
            end
...
function fn()
    local assetname = "sjy_bingpiniunaixuegao"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_bingpiniunaixuegao.xml" -- 在背包里的贴图
...
return Prefab("sjy_bingpiniunaixuegao", fn, assets, prefabs)