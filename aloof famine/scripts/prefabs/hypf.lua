...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.hypf = "热乎乎的炖菜!!!"

local assets = {Asset("ANIM", "anim/hypf.zip"), Asset("IMAGE", "images/hypf.tex"), Asset("ATLAS", "images/hypf.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/hypf.xml" -- 在背包里的贴图
...
return Prefab("hypf", fn, assets, prefabs)