...
local assets =
{
    Asset("ANIM", "anim/sjy_wanshengjieguo.zip"),
    Asset("ANIM", "anim/cook_pot_food.zip"),
    Asset("ANIM", "anim/ui_cookpot_1x4.zip"),
    Asset("IMAGE", "images/inventoryimages/sjy_wanshengjieguo.tex"),
    Asset("ATLAS", "images/inventoryimages/sjy_wanshengjieguo.xml"),
}
...
local function cookpot_common(inst)
    inst.AnimState:SetBank("sjy_wanshengjieguo")
    inst.AnimState:SetBuild("sjy_wanshengjieguo")
    inst.AnimState:PlayAnimation("idle_empty")
    inst.scrapbook_anim = "idle_empty"
    inst.MiniMapEntity:SetIcon("sjy_wanshengjieguo.tex")
end
...
local function MakeCookPot(name, common_postinit, master_postinit, assets, prefabs)
    local function fn()
        ...
        inst.components.container:WidgetSetup("sjy_wanshengjieguo")
...
return MakeCookPot("sjy_wanshengjieguo", cookpot_common, cookpot_common_master, assets, prefabs),
    MakePlacer("sjy_wanshengjieguo_placer", "sjy_wanshengjieguo", "sjy_wanshengjieguo", "idle_empty")
