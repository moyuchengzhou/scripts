...
local assets =
{
    ...
    Asset("IMAGE", "images/inventoryimages/sjy_mogu2_table.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_mogu2_table.xml"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("sjy_mogu2_table.tex")
    ...
    inst.components.container:WidgetSetup("sjy_mogu2_table")
...
return Prefab("sjy_mogu2_table", fn, assets, prefabs),
    MakePlacer("sjy_mogu2_table_placer", "sjy_mogu_table", "sjy_mogu_table", "idle22")
