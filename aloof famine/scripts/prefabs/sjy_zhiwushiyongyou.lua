...
local assets = {Asset("ANIM", "anim/sjy_zhiwushiyongyou.zip"),Asset("IMAGE", "images/inventoryimages/sjy_zhiwushiyongyou.tex"),Asset("ATLAS", "images/inventoryimages/sjy_zhiwushiyongyou.xml")}
...
function fn()
    local assetname = "sjy_zhiwushiyongyou"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_zhiwushiyongyou.xml" -- 在背包里的贴图
...
return Prefab("sjy_zhiwushiyongyou", fn, assets, prefabs)