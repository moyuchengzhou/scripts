...
local assets = {Asset("ANIM", "anim/sjy_molihuacha.zip"),Asset("IMAGE", "images/inventoryimages/sjy_molihuacha.tex"),Asset("ATLAS", "images/inventoryimages/sjy_molihuacha.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_spawn_creatures", "sjy_buff_spawn_creatures")
...
function fn()
    local assetname = "sjy_molihuacha"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_molihuacha.xml" -- 在背包里的贴图
...
return Prefab("sjy_molihuacha", fn, assets, prefabs)