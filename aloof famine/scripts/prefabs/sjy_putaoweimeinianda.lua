...
local assets = {Asset("ANIM", "anim/sjy_putaoweimeinianda.zip"),Asset("IMAGE", "images/inventoryimages/sjy_putaoweimeinianda.tex"),Asset("ATLAS", "images/inventoryimages/sjy_putaoweimeinianda.xml")}
...
function fn()
    local assetname = "sjy_putaoweimeinianda"
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_putaoweimeinianda.xml" -- 在背包里的贴图
...
return Prefab("sjy_putaoweimeinianda", fn, assets, prefabs)