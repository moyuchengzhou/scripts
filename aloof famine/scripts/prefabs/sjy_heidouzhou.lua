...
local assets = {Asset("ANIM", "anim/sjy_heidouzhou.zip"), Asset("IMAGE", "images/sjy_heidouzhou.tex"), Asset("ATLAS", "images/sjy_heidouzhou.xml")}
...
function fn()
    local assetname = "sjy_heidouzhou"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_heidouzhou.xml" -- 在背包里的贴图
...
return Prefab("sjy_heidouzhou", fn, assets, prefabs)