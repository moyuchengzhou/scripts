...
local assets = 
{
   Asset("ANIM", "anim/sjy_wsj_meiqiuguai.zip"),
   Asset("IMAGE", "images/inventoryimages/sjy_wsj_meiqiuguai.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_wsj_meiqiuguai.xml"), --默认:雪人
}
...
function fn()
   ...
   inst.AnimState:SetBank("sjy_wsj_meiqiuguai")        --
   inst.AnimState:SetBuild("sjy_wsj_meiqiuguai")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_wsj_meiqiuguai")                   --独有标签
...
return Prefab("sjy_wsj_meiqiuguai", fn, assets),
MakePlacer("sjy_wsj_meiqiuguai_placer", "sjy_wsj_meiqiuguai", "sjy_wsj_meiqiuguai", "idle")