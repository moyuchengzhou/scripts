local assets =
{
    ...
    Asset("IMAGE", "images/inventoryimages/sjy_xiaomai.tex"),
	Asset("ATLAS", "images/inventoryimages/sjy_xiaomai.xml"),
}
...
local function dig_up(inst, worker)
    if inst.components.pickable ~= nil and inst.components.lootdropper ~= nil then
        ...
        if inst.components.pickable:CanBePicked() then
            ...
            inst.components.lootdropper:SpawnLootPrefab(withered and "sjy_xiaomaibean" or "dug_sjy_xiaomai")
        end
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon(sjy_xiaomai..".tex")
    ...
    inst.components.pickable:SetUp("sjy_xiaomaibean", 960,3)
...
return Prefab("sjy_xiaomai", fn, assets, prefabs)
