...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.LZCQ = "蘸汁食用的小吃"

local assets = {Asset("ANIM", "anim/lzcq.zip"), Asset("IMAGE", "images/lzcq.tex"), Asset("ATLAS", "images/lzcq.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("如同史莱姆一般圆滚滚的脆球，盛着鲜艳神秘的汁水!!!")		
            end
        end
end

function fn()
    local assetname = "lzcq"
    ...
    inst.components.inventoryitem.atlasname = "images/lzcq.xml" -- 在背包里的贴图
...
return Prefab("lzcq", fn, assets, prefabs)