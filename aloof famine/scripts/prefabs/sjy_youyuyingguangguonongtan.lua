...
local assets = {Asset("ANIM", "anim/sjy_youyuyingguangguonongtan.zip"), Asset("IMAGE", "images/sjy_youyuyingguangguonongtan.tex"), Asset("ATLAS", "images/sjy_youyuyingguangguonongtan.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("咦真恶心~")		
            end
...
function fn()
    local assetname = "sjy_youyuyingguangguonongtan"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_youyuyingguangguonongtan.xml" -- 在背包里的贴图
...
return Prefab("sjy_youyuyingguangguonongtan", fn, assets, prefabs)