...
local assets = {Asset("ANIM", "anim/sjy_babaozhou.zip"), Asset("IMAGE", "images/sjy_babaozhou.tex"), Asset("ATLAS", "images/sjy_babaozhou.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("是八宝粥！！")		
            end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_babaozhou.xml" -- 在背包里的贴图
...
return Prefab("sjy_babaozhou", fn, assets, prefabs)