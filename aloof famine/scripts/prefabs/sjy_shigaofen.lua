local assets =
{
    Asset("ANIM", "anim/sjy_shigaofen.zip"),
	Asset("IMAGE", "images/inventoryimages/sjy_shigaofen.tex"),
    Asset("ATLAS", "images/inventoryimages/sjy_shigaofen.xml"),
...
local function commonfn(anim, cookable)
    ...
    inst.AnimState:SetBank("sjy_shigaofen")
    inst.AnimState:SetBuild("sjy_shigaofen")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_shigaofen.xml"
...
return Prefab("sjy_shigaofen", defaultfn, assets)
