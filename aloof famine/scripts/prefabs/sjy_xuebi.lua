...
local assets = {Asset("ANIM", "anim/sjy_xuebi.zip"),Asset("IMAGE", "images/inventoryimages/sjy_xuebi.tex"),Asset("ATLAS", "images/inventoryimages/sjy_xuebi.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.debuffable:AddDebuff("sjy_buff_fire", "sjy_buff_fire")
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_xuebi.xml" -- 在背包里的贴图
...
return Prefab("sjy_xuebi", fn, assets, prefabs)