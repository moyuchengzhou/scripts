...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.sjy_paigu = "香喷喷的排骨!!!"

local assets = {Asset("ANIM", "anim/sjy_paigu.zip"), Asset("IMAGE", "images/sjy_paigu.tex"), Asset("ATLAS", "images/sjy_paigu.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("爽辣酥脆!!!!")		
            end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_paigu.xml" -- 在背包里的贴图
    ...
    inst.components.edible.hungervalue = 95
...
return Prefab("sjy_paigu", fn, assets, prefabs)