...
local assets = {Asset("ANIM", "anim/sjy_lvdouzhou.zip"), Asset("IMAGE", "images/sjy_lvdouzhou.tex"), Asset("ATLAS", "images/sjy_lvdouzhou.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_lvdouzhou.xml" -- 在背包里的贴图
...
return Prefab("sjy_lvdouzhou", fn, assets, prefabs)