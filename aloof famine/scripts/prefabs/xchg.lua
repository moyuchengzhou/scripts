...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.XCHG = "香草花糕"

local assets = {Asset("ANIM", "anim/xchg.zip"), Asset("IMAGE", "images/xchg.tex"), Asset("ATLAS", "images/xchg.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("丝滑香醇~")		
            end
        end
end

function fn()
    local assetname = "xchg"
    ...
    inst.components.inventoryitem.atlasname = "images/xchg.xml" -- 在背包里的贴图
...
return Prefab("xchg", fn, assets, prefabs)