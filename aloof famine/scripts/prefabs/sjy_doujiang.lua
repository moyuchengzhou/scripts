...
local assets = {Asset("ANIM", "anim/sjy_doujiang.zip"), Asset("IMAGE", "images/sjy_doujiang.tex"), Asset("ATLAS", "images/sjy_doujiang.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_doujiang.xml" -- 在背包里的贴图
...
return Prefab("sjy_doujiang", fn, assets, prefabs)