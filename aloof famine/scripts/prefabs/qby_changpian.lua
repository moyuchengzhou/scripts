local assets = {
    Asset("ANIM", "anim/qby_changpian.zip"),
    Asset("IMAGE", "images/inventoryimages/qby_changpian.tex"),
	Asset("ATLAS", "images/inventoryimages/qby_changpian.xml"),
...
local RECORDS = {
    default = {song = "xincp/BGM/qby", imageicon = nil,},
}
...
local function fn()
    ...
    inst.AnimState:SetBank("qby_changpian")
    inst.AnimState:SetBuild("qby_changpian")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/qby_changpian.xml"
...
return Prefab("qby_changpian", fn, assets)
