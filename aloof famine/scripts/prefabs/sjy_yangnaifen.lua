...
local assets = {Asset("ANIM", "anim/sjy_yangnaifen.zip"), Asset("IMAGE", "images/sjy_yangnaifen.tex"), Asset("ATLAS", "images/sjy_yangnaifen.xml"),Asset("IMAGE", "images/inventoryimages/sjy_yangnaifen.tex"),Asset("ATLAS", "images/inventoryimages/sjy_yangnaifen.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("干巴巴的奶粉")		
            end
...
function fn()
    local assetname = "sjy_yangnaifen"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_yangnaifen.xml" -- 在背包里的贴图
...
return Prefab("sjy_yangnaifen", fn, assets, prefabs)