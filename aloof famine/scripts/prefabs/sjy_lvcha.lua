...
local assets = {Asset("ANIM", "anim/sjy_lvcha.zip"),Asset("IMAGE", "images/inventoryimages/sjy_lvcha.tex"),Asset("ATLAS", "images/inventoryimages/sjy_lvcha.xml")}
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sjy_lvcha.xml" -- 在背包里的贴图
...
return Prefab("sjy_lvcha", fn, assets, prefabs)