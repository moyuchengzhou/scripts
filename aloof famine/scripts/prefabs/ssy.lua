...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SSY = "工艺复杂的鱼料理"

local assets = {Asset("ANIM", "anim/ssy.zip"), Asset("IMAGE", "images/ssy.tex"), Asset("ATLAS", "images/ssy.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("取整鱼剔骨，改菱形刀纹，裹上面粉后炸至金黄定型，装盘后浇上番茄汁!!!")		
            end
        end
end
...
function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/ssy.xml" -- 在背包里的贴图
...
return Prefab("ssy", fn, assets, prefabs)