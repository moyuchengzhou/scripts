...
local assets = {Asset("ANIM", "anim/sjy_zhushudedouzi.zip"), Asset("IMAGE", "images/sjy_zhushudedouzi.tex"), Asset("ATLAS", "images/sjy_zhushudedouzi.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("真难吃QAQ")		
            end
...
function fn()
    local assetname = "sjy_zhushudedouzi"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_zhushudedouzi.xml" -- 在背包里的贴图
...
return Prefab("sjy_zhushudedouzi", fn, assets, prefabs)