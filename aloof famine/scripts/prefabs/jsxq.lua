...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.JSXQ = "油炸小龙虾!!!"

local assets = {Asset("ANIM", "anim/jsxq.zip"), Asset("IMAGE", "images/jsxq.tex"), Asset("ATLAS", "images/jsxq.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("金黄酥脆的土豆丝薯香浓郁，咔哧一声，伴随着虾肉溢出的香甜汁水，满足感油然而生。一口一只，齿颊留香")		
            end
        end
end

function fn()
    local assetname = "jsxq"
    ...
    inst.components.inventoryitem.atlasname = "images/jsxq.xml" -- 在背包里的贴图
...
return Prefab("jsxq", fn, assets, prefabs)