...
local assets = {Asset("ANIM", "anim/sjy_yitongtudouni.zip"), Asset("IMAGE", "images/sjy_yitongtudouni.tex"), Asset("ATLAS", "images/sjy_yitongtudouni.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("不是正宗的！")		
            end
...
function fn()
    local assetname = "sjy_yitongtudouni"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_yitongtudouni.xml" -- 在背包里的贴图
...
return Prefab("sjy_yitongtudouni", fn, assets, prefabs)