...
local assets = 
{
   Asset("ANIM", "anim/sjy_wsj_lvsenanguadeng.zip"),      
   Asset("IMAGE", "images/inventoryimages/sjy_wsj_lvsenanguadeng.tex"),
   Asset("ATLAS", "images/inventoryimages/sjy_wsj_lvsenanguadeng.xml"),     --默认:雪人
}
...
function fn()
   ...
   inst.Light:SetColour(104/255, 255/255, 0/255)  --黄色

   inst.entity:AddAnimState()                      --添加动画组件
   inst.AnimState:SetBank("sjy_wsj_lvsenanguadeng")        --
   inst.AnimState:SetBuild("sjy_wsj_lvsenanguadeng")       --smcl文件的名字
   inst.AnimState:PlayAnimation("idle")            --动画子名称,播放的就是它

   inst:AddTag("sjy_wsj_lvsenanguadeng")                   --独有标签
...
return Prefab("sjy_wsj_lvsenanguadeng", fn, assets),
MakePlacer("sjy_wsj_lvsenanguadeng_placer", "sjy_wsj_lvsenanguadeng", "sjy_wsj_lvsenanguadeng", "idle")