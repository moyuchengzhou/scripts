...
local assets = {Asset("ANIM", "anim/sjy_youlingguodong.zip"), Asset("IMAGE", "images/sjy_youlingguodong.tex"), Asset("ATLAS", "images/sjy_youlingguodong.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        if eater.components.combat ~= nil then --这个buff需要攻击组件
            ...
            eater.components.talker:Say("酷酷的果冻~")		
            end
...
function fn()
    local assetname = "sjy_youlingguodong"
    ...
    inst.components.inventoryitem.atlasname = "images/sjy_youlingguodong.xml" -- 在背包里的贴图
...
return Prefab("sjy_youlingguodong", fn, assets, prefabs)