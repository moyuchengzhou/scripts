...
-- 加载贴图，动画
STRINGS.CHARACTERS.GENERIC.DESCRIBE.CCJTB = "以禽肉为主体制作的汉堡"

local assets = {Asset("ANIM", "anim/ccjtb.zip"), Asset("IMAGE", "images/ccjtb.tex"), Asset("ATLAS", "images/ccjtb.xml")}
...
local function oneaten(inst, eater)
    if eater.components.timer and eater:HasTag("player") then -- 判断是玩家
        ...
        eater.components.talker:Say("整块禽腿排金黄饱满，香嫩得能挤出肉汁。配合蔬菜的爽口和酱汁的香浓，让人如同身陷云端般，轻易沉醉在这掌中的美味!!!")		
            end
        end
end

function fn()
    local assetname = "ccjtb"
    ...
    inst.components.inventoryitem.atlasname = "images/ccjtb.xml" -- 在背包里的贴图
...
return Prefab("ccjtb", fn, assets, prefabs)